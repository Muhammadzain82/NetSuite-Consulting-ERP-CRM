...
//       {/* Content Area */}
//       <div className="relative h-full w-[70%] lg:left-[31%]">
//         <form onSubmit={handleSubmit} className="w-full h-full">
//           <div className="pl-10 w-full rounded-lg space-y-6 h-full flex flex-col">
...
//             {/* Current question and input - stays in original position */}
...
//               {validationErrors && (
//                 <ChatMessage message={validationErrors} isError className="mb-4" />
//               )}
...
//                       pattern={steps[currentStep]?.pattern || ".*"}
//                       title={steps[currentStep]?.title || "Please provide a valid input"}
//                       className="w-[90%] font-md border-b-2 border-[#3BAEEB] text-[#0B56E0] placeholder:font-normal focus:outline-none px-2 py-1 bg-transparent"
//                       required
//                       disabled={isTyping || isSubmitting}
//                     />
//                   </div>
